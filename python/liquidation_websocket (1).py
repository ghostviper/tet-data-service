...
class LiquidationWebSocket:
    ...
    async def prepare_tet_liquidation_data(self, redis_client, symbol, direction, liquidation_value, timestamp):
        ...
        # Note: Aggregated ZSET uses minute timestamp as member and aggregated value as score.
        # Cleaning by score would remove recent data incorrectly (scores are dollar amounts).
        # To avoid unintended deletion, skip score-based cleanup here.
        # A dedicated retention job should remove members by member timestamp.
